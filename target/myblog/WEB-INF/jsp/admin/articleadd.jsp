                ...
                <div class="am-g">
                    <div class="tpl-form-body tpl-form-line">
                        <form class="am-form tpl-form-line-form">
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" id="title" placeholder="请输入标题文字" required/>
                  ...
                  <!--          <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{searchBox: 1}" id="author">
...
-->
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" placeholder="输入文章描述" id="desc">
                                </div>
                            </div>
                                ...
                                <div class="am-u-sm-9">
                                    <div class="am-form-group am-form-file">
                                        <div class="tpl-form-file-img" id="preview">
                                            <!-- img src="resources/assets/img/a5.png" alt="" id="image" -->
                                        </div>
                                        <button type="button" class="am-btn am-btn-danger am-btn-sm">
                                            <i class="am-icon-cloud-upload"></i> 添加封面图片</button>
                                        <input id="image" type="file" multiple  onchange="preview(this)">
                                    </div>
                            ...
                            <div class="am-form-group">
                                <label for="user-phone" class="am-u-sm-3 am-form-label">添加分类 <span class="tpl-form-line-small-title">Type</span></label>
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{searchBox: 1}" id="articleType">
                            ...
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">添加优先级 <span class="tpl-form-line-small-title">Priority</span></label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="articlePriority" placeholder="1-100 越大优先级越高">
                                    <div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <div class="tpl-switch">
                                        <input type="checkbox" class="ios-switch bigswitch tpl-switch-btn" checked  id="isShow"/>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <div data-provide="am-md-editable" id="test">
